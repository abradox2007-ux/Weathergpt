...
export const UI_STRINGS: Record<string, Record<string, string>> = {
  en: {
    ...
    search_city_placeholder: 'Search any city or place worldwide (e.g. London, Tokyo, New York)...',
    global_hubs: 'Global Metros',
    recent_searches: 'Recent Searches',
    clear_history: 'Clear',
    worldwide: 'Worldwide',
    no_results_found: 'No matching global cities found',
